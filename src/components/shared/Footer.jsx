...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content my-2 rounded">
        ...
        <nav>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='w-5/6'>
              <span className='text-xs md:text-sm'>mystore@info.com</span>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='w-5/6'>
              <span className='text-xs md:text-sm'>www.mystore.com</span>
            </div>
          </div>
        </nav>
        <nav>
      ...
      <div>
        <hr />
        <aside className="flex flex-col md:flex-row items-center gap-2 mx-auto bg-base-200 justify-center py-5">
